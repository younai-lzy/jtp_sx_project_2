...
DROP TABLE IF EXISTS bodhidharma_disc.dwd_user_collection_log;
CREATE TABLE IF NOT EXISTS bodhidharma_disc.dwd_user_collection_log(
...
-- 用户收藏
INSERT INTO bodhidharma_disc.dwd_user_collection_log
SELECT
    t1.dt
    ,t1.log_id
    ,t1.order_id
