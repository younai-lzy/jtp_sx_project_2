DROP
CATALOG IF EXISTS hive_catalogs;
CREATE
CATALOG IF NOT EXISTS hive_catalogs PROPERTIES (
    'type'='hms', -- required
...
PARTITION BY RANGE (dt) (
    PARTITION p202510 VALUES LESS THAN ('2025-08-11')
    -- 可根据实际需求添加更多分区
)
...
-- 用户收藏
INSERT INTO bodhidharma_disc.dwd_user_behavior_log
SELECT
    t1.dt
    , t1.log_id
    , t1.order_id
