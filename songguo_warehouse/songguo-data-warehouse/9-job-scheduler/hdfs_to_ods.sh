...
;
ALTER TABLE songguo_warehouse.songgou_order_info ADD IF NOT EXISTS PARTITION (dt = '${data_date}');
"




SONGGUO_BIKE_STATUS_SQL="
...
(
    ...
    ALTER TABLE songguo_warehouse.songguo_bike_operation ADD IF NOT EXISTS PARTITION (dt = '${data_date}');
"



SONGGUO_USER_BEHAVIOR_SQL="
...
# 查询日志数据，插入明细事实表
SONGGUO_TRANSACTION_RECORD_SQL="
...
(
    ...
    ALTER TABLE songguo_warehouse.songgou_user_info ADD IF NOT EXISTS PARTITION (dt = '${data_date}');
"

SONGGUO_BIKE_INFO_SQL="--车辆信息表
 ...
 (
     ...
     ALTER TABLE songguo_warehouse.songguo_bike_info ADD IF NOT EXISTS PARTITION (dt = '${data_date}');
"

SONGGUO_CITY_INFO_SQL="
--城市信息表
...
(
    ...
    ALTER TABLE songguo_warehouse.songguo_city_info ADD IF NOT EXISTS PARTITION (dt = '${data_date}');
"

SONGGUO_CAMPAIGN_SQL="
--营销活动信息表
...
ALTER TABLE songguo_warehouse.songguo_campaign ADD IF NOT EXISTS PARTITION (dt = '${data_date}');
"
SONGGUO_BIKE_STATUS_TYPE_SQL="
...
ALTER TABLE songguo_warehouse.songguo_bike_status_type ADD IF NOT EXISTS PARTITION (dt = '${data_date}');
"
/opt/module/spark/bin/beeline -u jdbc:hive2://node101:10001 -n bwie -e "${SONGGOU_ORDER_INFO_SQL}${SONGGUO_BIKE_STATUS_SQL}${SONGGUO_BIKE_OPERATION_SQL}
${SONGGUO_USER_BEHAVIOR_SQL}${SONGGUO_TRANSACTION_RECORD_SQL}${SONGGOU_USER_INFO_SQL}${SONGGUO_BIKE_INFO_SQL}${SONGGUO_CITY_INFO_SQL}
${SONGGUO_CAMPAIGN_SQL}${SONGGUO_BIKE_STATUS_TYPE_SQL}"