...
(
    ...
    change_date  STRING COMMENT '价格变动日期，用于分区'
)
    COMMENT '商品价格变动日志表'
...
ALTER TABLE ods_price_trend_log
    ADD IF NOT EXISTS PARTITION (dt = '2025-08-06');
ALTER TABLE ods_price_trend_log
...
load data inpath 'hdfs://node101:8020/user/spark/warehouse/jtp_commodity_warehouse/ods_user_action_log/dt=2025-08-07'
    into table ods_user_action_log partition (dt = '2025-08-07');
